        ...
        if (data.data) {
            ...
            if (data.data.type === 'normal') {
                ...
                if (data.data) {
                    ...
                    setValue('price', data.data.prices[0].price)
                    setValue('cost_price', data.data.prices[1].price)
                    setValue('sale_price', data.data.prices[2].price)
                    setValue('calc_price', data.data.prices[3].price)
                    unregister('each')
                    unregister('box')
                }
