...
export const Suppliers = ({suppliers}) => {
    ...
    return (
        <div
                ...
                <>
                    <div className="mb-7 flex-1">
                        <table className="w-full">
                            <thead>
                            <tr>
                                <th colSpan={3} className="border">Independence</th>
                                <th colSpan={3} className="border">Teammed</th>
                                <th colSpan={3} className="border">Main Supplier</th>
                            </tr>
                            <tr>
            ...
            <button onClick={()=> suppliers({...suppliers, isOpen:false})} className="fixed bottom-2 rounded left-1/2 -translate-x-1/2 -translate-y-1/2 px-5 py-2 bg-amber-500 hover:bg-amber-500/70">Close</button>
        </div>
    )
}