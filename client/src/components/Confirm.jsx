...
const Confirm = ({close,data, confirm}) => {
    ...
    const singlePrice = data.data[index].Cprice[0] - 1/100
    const boxPrice = data.data[index].Cprice[1] -2/100
    ...
    return(
        <div className="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 px-28 py-10 bg-gray-700 text-gray-300 rounded-3xl">
